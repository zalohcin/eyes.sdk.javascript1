...
class CssTranslatePositionMemento extends PositionMemento {
  /**
   * @param {Object.<String, String>} transforms The current transforms. The keys are the style keys from which each of
  ...
  /**
   * @return {Object.<String, String>} The current transforms. The keys are the style keys from which each of the
