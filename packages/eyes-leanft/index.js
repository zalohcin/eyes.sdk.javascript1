...
exports.StitchMode = require('./src/Eyes').Eyes.StitchMode;
exports.EyesRegionProvider = require('./src/EyesRegionProvider').EyesRegionProvider;
exports.EyesWebTestObject = require('./src/EyesWebTestObject').EyesWebTestObject;
exports.EyesWebBrowser = require('./src/EyesWebBrowser').EyesWebBrowser;
exports.EyesStdWinWindow = require('./src/EyesStdWinWindow').EyesStdWinWindow;
exports.EyesLeanFTScreenshot = require('./src/EyesLeanFTScreenshot').EyesLeanFTScreenshot;
