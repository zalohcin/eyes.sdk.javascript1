...
module.exports = () => {
  var captureFrameAndPollForIE = (function () {
            'use strict';
            ...
            check(typeof globalThis == 'object' && globalThis) || check(typeof window == 'object' && window) || check(typeof self == 'object' && self) || check(typeof global$1 == 'object' && global$1) || // eslint-disable-next-line no-new-func
            ...
            */
            ...
            }; // Create object with fake `null` prototype: use ActiveX window.Object with cleared prototype
            ...
            var NullProtoObjectViaActiveX = function (activeXDocument) {
              ...
              return temp;
            }; // Create object with fake `null` prototype: use iframe window.Object with cleared prototype
            ...
            var arraySpeciesCreate = function (originalArray, length) {
              ...
              if (isArray(originalArray)) {
                ...
                if (typeof C == 'function' && (C === window.Array || isArray(C.prototype))) C = undefined;else if (isObject(C)) {
                  C = C[SPECIES];
                  if (C === null) C = undefined;
                }
              }

              return new (C === undefined ? window.Array : C)(length === 0 ? 0 : length);
            };
            ...
            var objectGetPrototypeOf = correctPrototypeGetter ? Object.getPrototypeOf : function (O) {
              ...
              return O instanceof window.Object ? ObjectPrototype$1 : null;
            };
            ...
            _export({
              ...
              slice: function slice(start, end) {
                ...
                if (isArray(O)) {
                  ...
                  if (typeof Constructor == 'function' && (Constructor === window.Array || isArray(Constructor.prototype))) {
                  ...
                  if (Constructor === window.Array || Constructor === undefined) {
                    return nativeSlice.call(O, k, fin);
                  }
                }

                result = new (Constructor === undefined ? window.Array : Constructor)(max$1(fin - k, 0));
            ...
            var defineIterator = function (Iterable, NAME, IteratorConstructor, next, DEFAULT, IS_SET, FORCED) {
              ...
              if (anyNativeIterator) {
                ...
                if (IteratorPrototype$2 !== Object.prototype && CurrentIteratorPrototype.next) {
                  ...
                  } // window.Set @@toStringTag to native iterators
            ...
            var es_array_iterator = defineIterator(window.Array, 'Array', function (iterated, kind) {
            ...
            var regexpExecAbstract = function (R, S) {
              ...
              if (typeof exec === 'function') {
                ...
                if (typeof result !== 'object') {
                  throw TypeError('RegExp exec method returned something other than an window.Object or null');
                }
            ...
            _export({
              ...
              test: function (str) {
                ...
                if (result !== null && !isObject(result)) {
                  throw new Error('RegExp exec method returned something other than an window.Object or null');
                }
            ...
            var support = {
              ...
              iterable: 'Symbol' in self && 'iterator' in window.Symbol,
  ...
  return captureFrameAndPollForIE()
}