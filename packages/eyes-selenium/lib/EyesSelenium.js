...
const isCheckViewport = require('./universal/isCheckViewport')
const checkViewport = require('./universal/checkViewport')
...
class EyesSelenium extends Eyes {
  ...
  async check(name, checkSettings) {
    ...
    if (isCheckViewport(checkSettings)) {
      return checkViewport({
        checkSettings,
        driver: this._driver,
        serverConnector: this._serverConnector,
        renderingInfoPromise: this._renderingInfoPromise,
