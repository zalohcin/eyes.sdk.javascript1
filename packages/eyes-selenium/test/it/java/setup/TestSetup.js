...
class TestSetup {
  ...
  async beforeMethod(methodName, beforeOpen) {
    ...
    if (seleniumServerUrl === 'https://ondemand.saucelabs.com/wd/hub' || seleniumServerUrl === 'http://ondemand.saucelabs.com/wd/hub') {
    ...
    } else if (seleniumServerUrl === 'https://hub-cloud.browserstack.com/wd/hub' || seleniumServerUrl === 'http://hub-cloud.browserstack.com/wd/hub') {
      this._desiredCaps.set('browserstack.user', process.env.BROWSERSTACK_USERNAME);
      this._desiredCaps.set('browserstack.key', process.env.BROWSERSTACK_ACCESS_KEY);
