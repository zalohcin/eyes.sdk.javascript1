...
describe('Eyes', function() {
  ...
  it('_getAndSaveScmMergeBaseTime() works with classic runner', async function() {
    const [res1, res2, res3] = await Promise.all([
      eyesClassic._getAndSaveScmMergeBaseTime('parentBranchName'),
      eyesClassic2._getAndSaveScmMergeBaseTime('parentBranchName'),
      eyesClassicOtherRuuner._getAndSaveScmMergeBaseTime('parentBranchName'),
    ])
