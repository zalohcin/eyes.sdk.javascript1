...
describe('TestIEyesVG', function () {
  ...
  const batchInfo = new BatchInfo('Top Sites - Visual Grid With Webhook');
  ...
  function getCheckSettings() {
    const jshook = "document.body.style='background-color: red'";
    return Target.window().beforeRenderScreenshotHook(jshook);
  }
