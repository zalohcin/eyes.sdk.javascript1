...
const { Eyes, Target, BatchInfo, VisualGridRunner, Configuration, RectangleSize } = require('../../../index');
...
describe('TestVGWithBadWebhook', function () {
  ...
  it('Test', async function () {
    ...
    await eyes.check(null, Target.window().fully().beforeRenderScreenshotHook('gibberish uncompilable java script'));
    await driver.quit();
