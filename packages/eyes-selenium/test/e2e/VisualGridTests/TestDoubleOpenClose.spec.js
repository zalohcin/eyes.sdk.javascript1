  ...
  [
    ...
    describe(`useVisualGrid: ${useVisualGrid}`, async function () {
      ...
      it('TestDoubleOpenCheckClose', async function () {
        ...
        try {
          eyes.open(driver, 'Applitools Eyes DotNet SDK', `TestDoubleOpenCheckClose${suffix}`, new RectangleSize(1200, 800));
          eyes.check(null, Target.window().fully().ignoreDisplacements(false).withName('Step 1'));
          eyes.close(false);

          eyes.open(driver, 'Applitools Eyes DotNet SDK', `TestDoubleOpenCheckClose${suffix}`, new RectangleSize(1200, 800));
          eyes.check(null, Target.window().fully().ignoreDisplacements(false).withName('Step 2'));
          eyes.close(false);
        } finally {
          driver.quit();
        }
      ...
      it('TestDoubleOpenCheckCloseAsync', async function () {
        ...
        try {
          await eyes.open(driver, 'Applitools Eyes DotNet SDK', `TestDoubleOpenCheckCloseAsync${suffix}`, new RectangleSize(1200, 800));
          await eyes.check(null, Target.window().fully().ignoreDisplacements(false).withName('Step 1'));
          await eyes.closeAsync();

          await eyes.open(driver, 'Applitools Eyes DotNet SDK', `TestDoubleOpenCheckCloseAsync${suffix}`, new RectangleSize(1200, 800));
          await eyes.check(null, Target.window().fully().ignoreDisplacements(false).withName('Step 2'));
          await eyes.closeAsync();
        } finally {
          await driver.quit();
        }
      ...
      it('TestDoubleOpenCheckCloseWithDifferentInstances', async function () {
        ...
        try {
          ...
          await eyes1.open(driver, 'Applitools Eyes DotNet SDK', `TestDoubleOpenCheckCloseWithDifferentInstances${suffix}`, new RectangleSize(1200, 800));
          await eyes1.check(null, Target.window().fully().ignoreDisplacements(false).withName('Step 1'));
          await eyes1.close(false);

          const eyes2 = new Eyes(runner);
          eyes2.setBatch(TestDataProvider.BatchInfo);
          await eyes2.open(driver, 'Applitools Eyes DotNet SDK', `TestDoubleOpenCheckCloseWithDifferentInstances${suffix}`, new RectangleSize(1200, 800));
          await eyes2.check(null, Target.window().fully().ignoreDisplacements(false).withName('Step 2'));
      ...
      it('TestDoubleOpenCheckCloseAsyncWithDifferentInstances', async function () {
        ...
        try {
          const eyes1 = new Eyes(runner);
          eyes1.setBatch(TestDataProvider.BatchInfo);
          await eyes1.open(driver, 'Applitools Eyes DotNet SDK', `TestDoubleOpenCheckCloseAsyncWithDifferentInstances${suffix}`, new RectangleSize(1200, 800));
          await eyes1.check(null, Target.window().fully().ignoreDisplacements(false).withName('Step 1'));
          await eyes1.closeAsync();

          const eyes2 = new Eyes(runner);
          eyes2.setBatch(TestDataProvider.BatchInfo);
          await eyes2.open(driver, 'Applitools Eyes DotNet SDK', `TestDoubleOpenCheckCloseAsyncWithDifferentInstances${suffix}`, new RectangleSize(1200, 800));
          await eyes2.check(null, Target.window().fully().ignoreDisplacements(false).withName('Step 2'));
      ...
      it('TestDoubleCheckDontGetAllResults', async function () {
        ...
        try {
          const eyes1 = new Eyes(runner);
          eyes1.setBatch(TestDataProvider.BatchInfo);
          await eyes1.open(driver, 'Applitools Eyes DotNet SDK', `TestDoubleCheckDontGetAllResults${suffix}`, new RectangleSize(1200, 800));
