...
const { Eyes, Target, VisualGridRunner, DeviceName, BrowserType, RectangleSize } = require('../../../index');
...
describe('TestTimeouts', function () {
  ...
  it('TestTimeout', async function () {
    ...
    try {
      ...
      await eyes.open(driver, 'Timeout Test', 'Visual Grid Timeout Test', new RectangleSize(1200, 800));
