...
const { Eyes, ClassicRunner, Target, BatchInfo, RectangleSize, StitchMode } = require('../../../index');
...
describe('TestBatchApi', function () {
  it('TestCloseBatch', async function () {
    ...
    let batch;
    try {
      await eyes.open(driver, 'Applitools Eyes SDK', 'Classic Runner Test', new RectangleSize(1200, 800));
