module.exports = [
  ...
  {name: 'TestCheckElementFully_Fluent', executionMode: {isVisualGrid: true}, baselineVersion: 1},
  ...
  {name: 'TestCheckFrame_Fluent', executionMode: {isCssStitching: true}, baselineVersion: 2},
  {name: 'TestCheckFrame_Fluent', executionMode: {isScrollStitching: true}, baselineVersion: 2},
  ...
  {name: 'TestCheckRegion', executionMode: {isVisualGrid: true}, baselineVersion: 1},
  {name: 'TestCheckRegion', executionMode: {isCssStitching: true}},
  {name: 'TestCheckRegion', executionMode: {isScrollStitching: true}},
  {name: 'TestCheckRegion2', executionMode: {isVisualGrid: true}, baselineVersion: 1},
  ...
  {name: 'TestCheckFixedRegion_Fully', executionMode: {isVisualGrid: true}, baselineVersion: 1},
  ...
  {name: 'RefreshStaleScrollRootElementAfterPageReload', executionMode: {isCssStitching: true}},
  {name: 'CheckStaleElement', executionMode: {isCssStitching: true}},
  {name: 'CheckRefreshableElement', executionMode: {isCssStitching: true}, disabled: true},
  {
    name: 'CheckRefreshableElementInsideFrame',
    executionMode: {isCssStitching: true},
    disabled: true,
  },
  ...
  {name: 'CheckPageWithBurgerMenuFully', executionMode: {isCssStitching: true}},
]
