...
class SafariScreenshotImageProvider extends ImageProvider {
  ...
  _initDeviceRegionsTable() {
    ...
    this._devicesRegions.set(new DeviceData(1536, 2048).hashCode(), [
      new Region(0, 141, 1536, 1907),
      new Region(0, 206, 1536, 1842),
      new Region(0, 129, 1536, 1919),
      new Region(0, 194, 1536, 1854),
    ])
    this._devicesRegions.set(new DeviceData(2048, 1536).hashCode(), [
    ...
    this._devicesRegions.set(new DeviceData(1242, 2688).hashCode(), [
      new Region(0, 283, 1242, 2155),
    ])
    this._devicesRegions.set(new DeviceData(2688, 1242).hashCode(), [
      new Region(132, 151, 2424, 1028),
    ])

    this._devicesRegions.set(new DeviceData(1125, 2436).hashCode(), [
      new Region(0, 283, 1125, 1903),
    ])
    this._devicesRegions.set(new DeviceData(2436, 1125).hashCode(), [
      new Region(132, 151, 2172, 930),
    ])

    this._devicesRegions.set(new DeviceData(1242, 2208).hashCode(), [
      new Region(0, 211, 1242, 1863),
      new Region(0, 193, 1242, 1882),
    ])
    this._devicesRegions.set(new DeviceData(2208, 1242).hashCode(), [
      new Region(0, 151, 2208, 1090),
      new Region(0, 231, 2208, 1010),
    ])

    this._devicesRegions.set(new DeviceData(750, 1334).hashCode(), [
      new Region(0, 141, 750, 1104),
      new Region(0, 129, 750, 1116),
    ])
    this._devicesRegions.set(new DeviceData(1334, 750).hashCode(), [
      new Region(0, 101, 1334, 648),
      new Region(0, 89, 1334, 660),
    ])
    ...
    this._devicesRegions.set(new DeviceData(2048, 2732).hashCode(), [
      new Region(0, 141, 2048, 2591),
    ])
    this._devicesRegions.set(new DeviceData(2732, 2048).hashCode(), [
      new Region(0, 141, 2732, 1907),
    ])

    this._devicesRegions.set(new DeviceData(1668, 2224).hashCode(), [
      new Region(0, 141, 1668, 2083),
    ])
    this._devicesRegions.set(new DeviceData(2224, 1668).hashCode(), [
      new Region(0, 141, 2224, 1527),
    ])
  }
}
