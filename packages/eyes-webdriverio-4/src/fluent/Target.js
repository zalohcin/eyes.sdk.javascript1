...
class Target {
   ...
   *
   * @param {Region|RegionObject|By|EyesWebElement} region The region to validate.
   * @param {Integer|String|By|EyesWebElement} [frame] The element which is the frame to switch to.
   * @return {WebdriverioCheckSettings}
   * @constructor
   */
