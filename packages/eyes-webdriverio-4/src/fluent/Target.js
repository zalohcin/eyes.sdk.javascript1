...
class Target {
   ...
   *
   * @param {Region|RegionObject|By|String|WDIOElement} region The region to validate.
   * @param {Integer|String|By|WDIOElement} [frame] The element which is the frame to switch to.
   * @return {WebdriverioCheckSettings}
   * @constructor
   */
