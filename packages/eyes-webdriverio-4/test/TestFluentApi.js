...
const {Region, AccessibilityLevel, AccessibilityRegionType} = require('@applitools/eyes-sdk-core')
...
shared.examplesFor('TestFluentApi', function(test) {
  ...
  it.skip('TestAccessibilityRegions', async () => {
    ...
    await test.eyes.check(
      'Main Page',
      Target.window().accessibilityRegion(By.css('.ignore'), AccessibilityRegionType.LargeText),
    )
