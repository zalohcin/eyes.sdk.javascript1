...
describe(`${appName} Scroll`, () => {
  ...
  it.skip(`TestCheckLongOutOfBoundsIFrameModal`, async () => {
    let driver = await eyes.open(webDriver, appName, `TestCheckLongOutOfBoundsIFrameModal_Scroll`, {
      width: 700,
      height: 460,
    })
  ...
  it('TestAccessibilityRegions', async () => {
    await eyes.open(webDriver, appName, 'TestAccessibilityRegions_Scroll', {
      width: 700,
      height: 460,
    })
