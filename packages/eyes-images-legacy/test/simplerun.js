...
var firstTestPromise = eyes
  .open('eyes.images.javascript', 'First test5_3', {width: 800, height: 600})
  .then(function() {
  ...
  .then(function() {
    ...
    eyes.addMouseTrigger(
      EyesImages.Triggers.MouseAction.Click,
      {left: 288, top: 44, width: 92, height: 36},
      {x: 10, y: 10},
    )
    return eyes.checkImage(image1, 'My first image')
  })
  .then(function() {
    return eyes.checkRegion(
      {left: 495, top: 100, width: 355, height: 360},
      image1,
      'Specific region',
    )
  })
